		...
		return <div>
			...
			<WidgetContainer>
				...
				>
					{
						attrs.friendReviews
							.filter(r => remoteData.Interactions.some(i => r.author === i.subject && i.subjectType === globals.USER && i.type === globals.FOLLOW))
...
const SetDetail = {
	...
	view: ({ attrs }) => {
		...
		const eventCheckins = messages.getFiltered(_.assign({ messageType: globals.CHECKIN }, subjectObject))
