		...
		<div class="main-stage">
			...
			<WidgetContainer>
				...
				<ActivityWidget 
					...
					userId={attrs.userId} 
					popModal={attrs.popModal}
					artistIds={remoteData.Festivals.reviewedArtistIds(attrs.festivalId, attrs.userId)} 
				/>
				<ArtistSearchWidget 
					festivalId={attrs.festivalId} 
					overlay={'research'} 
...
const Research = {
	...
	preload: (rParams) => {
		...
		return (seriesId && !festivalId ? series.subjectDetails(so) :
			festivalId ? festivals.subjectDetails(so) :
	...
	oninit: ({attrs}) => {
		...
		return type === FESTIVAL && attrs.auth.getGttDecoded(so)
